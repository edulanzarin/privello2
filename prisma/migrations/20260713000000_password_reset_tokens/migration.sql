-- Migration: tokens de reset de senha.
--
-- Estrutura completa pronta. O envio de email ainda não está
-- integrado — quando estiver, basta ler o token gerado por
-- `criarTokenResetSenha` e mandar via SendGrid/Resend/SES.
