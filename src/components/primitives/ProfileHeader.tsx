    ...
    const avatarRender =
        hasStoryRing && onStoryClick !== undefined ? (
            <button
                ...
                className="inline-flex shrink-0 rounded-full transition-transform hover:scale-[1.03] active:scale-95 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent/40"
            >
                <Avatar
                    src={photoUrl}
                    name={name}
