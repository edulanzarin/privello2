...
export function CommentInput({
    ...
    return (
        ...
        >
            ...
            <div className="flex min-w-0 flex-1 items-end gap-2 rounded-full border border-border bg-surface px-3 py-1.5 transition-all focus-within:border-accent/40 focus-within:ring-2 focus-within:ring-accent/25">
                <textarea
                    rows={1}
                    value={value}
                ...
                <button
                    type="submit"
                    disabled={!canSubmit}
                    className="flex-none rounded-full bg-gradient-to-br from-accent to-accent-deep px-3 py-1 text-xs font-semibold text-white shadow-[0_4px_12px_-4px_rgba(197,82,58,0.45)] transition-transform hover:scale-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent/40 disabled:cursor-not-allowed disabled:opacity-40 disabled:shadow-none"
                >
                    Enviar
                </button>
            </div>
