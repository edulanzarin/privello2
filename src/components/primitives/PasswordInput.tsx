        ...
        <Input
            ...
            trailingIcon={
                <button
                    ...
                    className="pointer-events-auto -m-1 rounded p-1 text-text-secondary transition-colors hover:text-text-primary focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500/40"
