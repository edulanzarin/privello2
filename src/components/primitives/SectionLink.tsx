...
export function SectionLink({
    ...
    const composed = [
        "inline-flex items-center gap-1.5 text-sm font-medium tracking-tight text-primary-700 transition-colors hover:text-primary-800 focus:outline-none focus-visible:underline",
        className ?? "",
    ]
        .filter(Boolean)
        .join(" ");
