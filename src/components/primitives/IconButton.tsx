...
const TONE_CLASSES: Record<IconButtonTone, string> = {
    primary:
        "bg-gradient-to-br from-accent to-accent-deep text-white shadow-[0_4px_12px_-4px_rgba(197,82,58,0.45)] hover:scale-105 transition-transform focus-visible:ring-accent/40",
    neutral:
        "border border-border bg-surface text-text-secondary hover:border-accent/35 hover:text-accent-deep focus-visible:ring-accent/40",
    danger:
    ...
    ghost:
        "text-text-secondary hover:bg-neutral-100 hover:text-text-primary focus-visible:ring-accent/40",
};
