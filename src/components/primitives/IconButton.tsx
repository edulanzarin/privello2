...
const TONE_CLASSES: Record<IconButtonTone, string> = {
    primary:
        "bg-gradient-to-br from-[color:var(--accent)] to-[color:var(--accent-deep)] text-white shadow-[0_4px_12px_-4px_rgba(197,82,58,0.45)] hover:scale-105 transition-transform focus-visible:ring-[#ec7b5b]/40",
    neutral:
        "border border-border bg-surface text-text-secondary hover:border-[#ec7b5b]/35 hover:text-[color:var(--accent-deep)] focus-visible:ring-[#ec7b5b]/40",
    danger:
    ...
    ghost:
        "text-text-secondary hover:bg-neutral-100 hover:text-text-primary focus-visible:ring-[#ec7b5b]/40",
};
